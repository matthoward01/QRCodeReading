...
namespace QRCodeReading
{
    class Program
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            await GetQrCodesAsync(pdfDirectory, resolutionInc.ToString());

            Console.WriteLine("Done...");
            Console.ReadLine();
        }

        private static async Task GetQrCodesAsync(string pdfDirectory, string resolution)
        {
            ...
            await Task.WhenAll(filesList.Select(f => ProcessFileAsync(f, resolution, outputFile)));
        }
